package com.suggestion.book.global.oauth.hendler;
...
import com.suggestion.book.global.oauth.token.AuthToken;
import com.suggestion.book.global.oauth.token.AuthTokenProvider;
import com.suggestion.book.global.utils.CookieUtil;
...
import static com.suggestion.book.global.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REDIRECT_URI_PARAM_COOKIE_NAME;
import static com.suggestion.book.global.oauth.repository.OAuth2AuthorizationRequestBasedOnCookieRepository.REFRESH_TOKEN;
...
public class OAuth2AuthenticationSuccessHandler extends SimpleUrlAuthenticationSuccessHandler {
    ...
    protected String determineTargetUrl(HttpServletRequest request, HttpServletResponse response, Authentication authentication) {
        ...
        // DB 저장
        MemberRefreshToken memberRefreshToken = memberRefreshTokenRepository.findByMemberId(userInfo.getId());
